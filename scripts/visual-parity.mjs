...
for (const route of ROUTES) {
  ...
  try {
    ...
    flaskClasses = (html.match(/class="[^"]*\b(site-|home-|feature-|admin-|auth-page|register-container|tool-|story-|clipboard-|image-hosting|vote-|checkin-|fish-|profile-|settings-|fortune-)/g) || []).length;
