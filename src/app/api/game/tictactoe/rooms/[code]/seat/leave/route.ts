// POST /api/game/tictactoe/rooms/[code]/seat/leave — 从席位退到观战台
//
...
import { makeLeaveSeatHandler } from '../../../../../_shared';

export const runtime = 'nodejs';
export const dynamic = 'force-dynamic';

export const POST = makeLeaveSeatHandler('tictactoe', roomApi);
