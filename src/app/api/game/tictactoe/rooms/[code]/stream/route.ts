// ─────────────────────────────────────────────────────────────────────────────
// GET /api/game/tictactoe/rooms/:code/stream — 对局实时流（SSE）
//
// 单向推送足够：落子仍走 POST /api/game/tictactoe/rooms/:code/moves，白拿 CSRF 同源
...
import { getSnapshot, refreshPresence } from '@/lib/tictactoe-room';
