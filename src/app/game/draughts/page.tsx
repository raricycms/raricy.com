...
export const metadata = { title: '国际跳棋 · 聪明山' };

const SOLO_DESC = '白先黑后，10×10 只走深色格。吃子强制、必须吃最多的一路，兵到底线成王。同一台设备两人轮流走。';
...
export default async function Page({
  ...
  if (sp.mode !== 'online') {
    return (
      <GamePageShell
        title="国际跳棋"
        pageClass="draughts-page"
        backClass="draughts-back"
