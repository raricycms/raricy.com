...
export const metadata = { title: '国际象棋 · 聪明山' };

const SOLO_DESC = '白先黑后，8×8。王车易位、吃过路兵、兵升变俱全，将死取胜，逼和与五十回合判和。同一台设备两人轮流走。';
...
export default async function Page({
  ...
  if (sp.mode !== 'online') {
    return (
      <GamePageShell
        title="国际象棋"
        pageClass="chess-page"
        backClass="chess-back"
