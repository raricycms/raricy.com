...
// 对齐 Flask tool.cattca_guide：读取 docs/cattca-guide.md，服务端渲染为 HTML（fenced code + tables），
// 套用 cattca_guide.html 的 .guide 布局。内容为仓库内可信文档（非用户输入）。
export const metadata = { title: 'Cattca 语法指南 · 聪明山' };

// docs/ 与 web-next/ 同级（进程 cwd 为 web-next，向上一级到仓库根）。
